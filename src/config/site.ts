...
export const siteConfig = {
  brand: {
    ...
    description:
      "Юридическое сопровождение. Юридическая помощь населению и бизнесу.",
  },
  seo: {
    siteUrl,
    title: "Legal Protection - юридическое сопровождение в Астане",
    description:
      "Консалтинговый центр Legal Protection: юридическое сопровождение, судебное представительство и абонентское обслуживание для бизнеса и частных лиц.",
    locale: "ru_RU",
  },
  media: {
    logo: withBasePath("/gold-720.png"),
    heroImage: withBasePath("/media/hero-poster-768.jpg"),
  ...
  contacts: {
    ...
    instagramHref: "https://www.instagram.com/_u/legal_protectionkz/",
  ...
  hero: {
    title: "Legal Protection — Помогаем населению и бизнесу решать правовые задачи спокойно, последовательно и в понятных сроках.",
    text: "",
  ...
  subscription: {
    ...
    benefits: [
      "Единое окно по юридическим вопросам",
  ...
  about: {
    title: "О нас",
    intro:
      "Legal Protection - консалтинговый центр, который сопровождает частных клиентов и компании по юридическим вопросам.",
    approach: [
  ...
  faq: [
    ...
    {
      question: "Можно ли подключить только юридическое сопровождение?",
      answer: "Да, формат сопровождения настраивается под конкретный юридический запрос.",
    },
    {
