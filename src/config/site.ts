...
export const siteConfig = {
  ...
  media: {
    logo: withBasePath("/123.png"),
    heroImage: withBasePath("/media/hero-placeholder.svg"),
    officeImage: withBasePath("/media/nas.jpg"),
    heroVideo: withBasePath("/Timeline.mov"),
  },
  nav: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Да, возможны разовые консультации и отдельные проектные задачи.",
    },
  ] as FAQItem[],
  privacy: {
