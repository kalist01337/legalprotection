...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="relative -mt-[148px] min-h-[58vh] overflow-hidden pt-[148px] sm:-mt-[188px] sm:min-h-[88vh] sm:pt-[188px] lg:-mt-[206px] lg:min-h-[86vh] lg:pt-[206px]">
        <div className="hero-media-mask pointer-events-none absolute inset-0">
          ...
          <div className="absolute inset-x-0 top-0 h-24 bg-[linear-gradient(to_bottom,rgba(7,7,7,0.88)_0%,rgba(7,7,7,0.35)_48%,rgba(7,7,7,0)_100%)] sm:h-44 lg:h-52" />
          <div className="absolute inset-x-0 bottom-0 h-32 bg-[linear-gradient(to_bottom,rgba(11,11,11,0)_0%,rgba(11,11,11,0.22)_34%,rgba(11,11,11,0.6)_70%,#0b0b0b_100%)] sm:h-44 lg:h-48" />
        </div>
